import 'package:chattercrafting/localdb/localdb.dart';
...
class PaLMService implements IService {
  static const paLMModels = [PaLMConstants.chatBisonName];
  static const paLMModelNameMapping = {
    PaLMConstants.chatBisonName : PaLMConstants.chatBisonId
  };

  @override
  final ServiceType type = ServiceType.paLM;
  @override
  ...
  Map<String, dynamic> toMap() {
    return {
      SQFliteHelper.paLMColumnServiceType: type.index,
  ...
  factory PaLMService.fromMap(Map<String, dynamic> map) {
    return PaLMService(
      id: map[SQFliteHelper.paLMColumnId] as int?, // This is always null until I make local db table
